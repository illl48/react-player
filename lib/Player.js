...
var Player = function (_Component) {
  ...
  function Player() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Player.__proto__ || Object.getPrototypeOf(Player)).call.apply(_ref, [this].concat(args))), _this), _this.mounted = false, _this.isReady = false, _this.isPlaying = false, _this.startOnPlay = true, _this.seekOnPlay = null, _this.getInternalPlayer = function (key) {
      if (!_this.player) return null;
      return _this.player[key];
    }, _this.onReady = function () {
      console.log('dqqdqw');
      if (!_this.mounted) {
        setTimeout(_this.onReady, 500);
        return;
      }
