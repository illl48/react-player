    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      try {
        for (var _iterator = Object.keys(this.props)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (!(0, _utils.isObject)(prop) && prop !== nextProps[key]) {
            return true;
          }
        }
      } catch (err) {
...
ReactPlayer.canPlay = function (url) {
  ...
  try {
    for (var _iterator3 = _players2['default'][Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
