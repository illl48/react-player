...
var FLV_SDK_URL = 'https://cdnjs.cloudflare.com/ajax/libs/flv.js/1.3.3/flv.min.js';
  ...
  _createClass(FilePlayer, [{
    ...
    value: function addListeners(player) {
      var _this$props2 = this.props,
          ...
          onEnablePIP = _this$props2.onEnablePIP; // https://stackoverflow.com/questions/10235919/the-canplay-canplaythrough-events-for-an-html5-video-are-not-called-on-firefox
    ...
    value: function load(url) {
      ...
      if (this.shouldUseFLV(url)) {
        (0, _utils.getSDK)(FLV_SDK_URL, FLV_GLOBAL).then(function (flvjs) {
          if (!flvjs.isSupported()) return;
          var _this2$props$config$f = _this2.props.config.file.flvjs,
              mediaDataSource = _this2$props$config$f.mediaDataSource,
              config = _this2$props$config$f.config;
          _this2.flv = flvjs.createPlayer(_objectSpread({
            url: url
