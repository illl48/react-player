...
var FilePlayer = function (_Component) {
  ...
  _createClass(FilePlayer, [{
    ...
    value: function load(url) {
      ...
      if (this.shouldUseFLV(url)) {
        (0, _utils.getSDK)(FLV_SDK_URL, FLV_GLOBAL).then(function (flvjs) {
          ...
          var _props$config$file$fl = _this2.props.config.file.flvjs,
              mediaDataSource = _props$config$file$fl.mediaDataSource,
              config = _props$config$file$fl.config;

          _this2.flv = flvjs.createPlayer(_extends({ url: url }, mediaDataSource), config);
    ...
    value: function render() {
      ...
      var src = url instanceof Array || useHLS || useDASH || useFlv ? undefined : url;
      var style = {
